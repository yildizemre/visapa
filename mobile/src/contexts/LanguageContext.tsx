...
const translations: Record<Language, Record<string, string>> = {
  tr: {
    ...
    'chat.placeholder': 'Mağaza verileriniz hakkında soru sorun.',
    'chat.inputPlaceholder': 'Mesajınızı yazın...',
    'chat.send': 'Gönder',
    'chat.noResponse': 'Yanıt alınamadı. Lütfen tekrar deneyin.',
    'chat.connectionError': 'Bağlantı hatası. Lütfen tekrar deneyin.',
    ...
    'report.accessDenied': 'Bu sayfaya erişim yetkiniz yok. Sadece yöneticiler rapor analizine erişebilir.',
  ...
  en: {
    ...
    'chat.placeholder': 'Ask about your store data.',
    'chat.inputPlaceholder': 'Type your message...',
    'chat.send': 'Send',
    'chat.noResponse': 'No response received. Please try again.',
    ...
    'report.accessDenied': 'You do not have permission. Only administrators can access report analytics.',
