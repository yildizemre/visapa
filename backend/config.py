...
def _cors_origins():
    ...
    return ['http://localhost:5173', 'http://127.0.0.1:5173', 'http://192.168.1.65:5173', 'http://192.168.1.101:5173']
...
# Daima backend/instance/vislivis.db'yi kullan - calisitrilan dizinden bagimsiz
_backend_dir = os.path.dirname(os.path.abspath(__file__))
_default_db = 'sqlite:///' + os.path.join(_backend_dir, 'instance', 'vislivis.db').replace('\\', '/')
